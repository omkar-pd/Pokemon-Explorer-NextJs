      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex-1">
            <h1 className="text-3xl font-bold text-gray-900">Pokémon Comparison</h1>
            <p className="text-gray-600">
              {leftPokemon && rightPokemon
                ? `${leftPokemon} vs ${rightPokemon}`
                : leftPokemon
                  ? `${leftPokemon} - Select another Pokémon to compare`
                  : rightPokemon
                    ? `Select a Pokémon to compare with ${rightPokemon}`
